...
const commandTestCases: CommandTestCase[] = [
  ...
  },
  {
    ...
    input: '500',
    expectedOutput: 'cd=48,m2=0,mp2=500,ms2=2,st2=18:31,et2=23:59,re2=127',
  },
  {
    description: 'Venus E Mini schedule rejects an out-of-sequence slot',
    deviceType: 'VNSEMINI-0',
    initialState: {
      timePeriods: [
        {
